    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException{
      ...
      try
      {
        ...
        String urlParameters = "code=" + 
          code + 
          "&client_id=" + "587645688652-0msja98f50i52bm9178eleus8gk6uafs.apps.googleusercontent.com" +
          "&client_secret=" + "Co4lEqZPBcK1C7Nvz5kEahbH" + 
          "&redirect_uri=" + "http://localhost:8001/p/googleLogin" +
        ...
        if(c != null) {
        	...
        	Customer c1 = new CustomerService().insertGoogle(data.getId(),data.getName(),data.getEmail(),actoken);
        	HttpSession session = request.getSession();
