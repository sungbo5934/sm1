...
<body>
	...
	<div id='A_Container_Wrap'>
		<div id='A_Container'>
			...
			<br>
			<h3>"회원님"의 평가 | 상품들</h3>
			<div style="float:left; border:1px solid lightgray; width:750px; height:300px; ">
			...
			<div class="tableContainer">
				...
				<div class="requestAd">
					<button style="border:1px solid red; color:red; background:white; border-radius:5px; width:100px; height:30px;">
					광고 신청</button>
					<button style="border:1px solid red; color:red; background:white; border-radius:5px; width:100px; height:30px;"
					onclick="location.href='/p/views/pay/ChargeCash.jsp'">
					캐시충전
					</button>
				</div>
			</div>
