...
<%@ page language="java" contentType="text/html; charset=UTF-8"
 ...
 <% product cart =(product)request.getAttribute("product"); %>      
   ...
   <div class="gumai-container">
	   ...
	   <% if(cart != null){ %>
	   	<li>
   			...
   			<p style="color:skyblue; float:left; margin-top:5px; margin-left:15px;"><%= cart.getCategoryName() %> </p>
   			<br><h3 style="margin-left:195px; font-weight:900;"><%= cart.getProductName() %> </h3>
   			<br>
   			<div style="padding-right:20px; text-align:right; padding-left:20px; margin-top:15px;">
   			<p style="float:left; margin-left:15px"><%= cart.getSellerName() %> 
   			</p><p style="float:right"><%= cart.getCustomerRating() %>  </p></div>
	   	</li>
	   	    <%}else{ %>
	   	<li>
			<h3>공유바구니</h3>
